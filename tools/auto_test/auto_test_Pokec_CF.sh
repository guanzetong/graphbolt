...
INIT_GRAPH="../../../../data2/ztguan/graphbolt/pokec/init_graph.adj"
PARTITION_FILE="../../../../data2/ztguan/graphbolt/pokec/partition.txt"
# PARTITION_FILE="../inputs/partition_empty.txt"
for DIR in ../../../../data2/ztguan/graphbolt/pokec/*/
do
    ...
    # then
        STREAM_PATH="../../../../data2/ztguan/graphbolt/pokec/$BATCH_SIZE/stream_graph.txt"
        EMPTY_STREAM_PATH="../inputs/stream_graph_empty.txt"
        SNAPSHOT_PATH="../../../../data2/ztguan/graphbolt/pokec/$BATCH_SIZE/snapshot"
