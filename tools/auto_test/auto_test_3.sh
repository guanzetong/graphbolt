...
INIT_GRAPH="../inputs/20220624/init_graph.adj"
# for DIR in ../inputs/20220624/*/
# do
    DIR=../inputs/20220624/1000/
    BATCH_SIZE=$(echo $DIR | cut -d '/' -f 4)
    echo $BATCH_SIZE
    STREAM_PATH="../inputs/20220624/$BATCH_SIZE/stream_graph.txt"
    EMPTY_STREAM_PATH="../inputs/stream_graph_empty.txt"
    SNAPSHOT_PATH="../inputs/20220624/$BATCH_SIZE/snapshot"
